			...
			if (columnfilter[columnOrderIdx] !== null) {
				if (renderSortOptions !== null) {
					...
					if (colname == sortcolumn) {
						...
						str += "<th style='max-width:200px;min-width:150px;text-overflow: ellipsis;overflow: hidden;' id='" + colname + DELIMITER + this.tableid + DELIMITER + "tbl' class='" + this.tableid + "'>" + renderSortOptions(colname, -1, col) + "</th>";
