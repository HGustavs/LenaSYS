...
?>
      ...
      if($requestedService=="accessed.php"){
			...
			if(isset($codeviewer)){
					...
					echo "<td class='navButt' id='afterbutton' title='Next example' onmousedown='Skip(\"fd\");' onmouseup='Skip(\"fu\");' onclick='Skip(\"f\");'><img id='afterButtonIcon' src='../Shared/icons/forward_button.svg' /></td>";
