		...
		<?php
			...
			if(isset($codeviewer)){
				    ...
				    echo     "<img class='navButt' src='../Shared/icons/tratt_white.svg'>";
					  echo     "<div id='dropdownc' class='dropdown-list-container' style='z-index: 2'>";
	          ...
	          echo   "</span>";
  					...
  					echo "<td id='sort' style='display:none' class='navButt'>";
						echo   "<span onmouseover='hovers();' onclick='leaves();'>";
  					echo     "<img class='navButt' src='../Shared/icons/sort_white.svg'>";
  			    echo     "<div id='dropdowns' class='dropdown-list-container' style='z-index: 2'>";
  					echo     "</div>";
  					echo   "</span>";
						echo "</td>";
