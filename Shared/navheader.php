<!-- Navigation Header! -->
	...
	<header>
				<?php
					...
					if(isset($codeviewer)){
							echo "<table class='tableclassen'><td class='navButt' id='beforebutton' title='Previous example' onmousedown='Skip(\"bd\");' onmouseup='Skip(\"bu\");' onclick='Skip(\"b\");'><img src='../Shared/icons/backward_button.svg'></td>";
							...
							echo "<td class='navSpacer'></td></table>";
					}

					if(checklogin()) {
								
							echo "<div id='loginbutton' class='loggedin'><img src='../Shared/icons/Man.svg' onclick='processLogout(\"";
							echo $loginvar;
							echo "\");' /></div>";
							echo "<div class='navName'><label id='userName'>".$_SESSION['loginname']."</label></div>";
					}else{
									
							echo "<div id='loginbutton' class='loggedout'><img src='../Shared/icons/Man.svg' onclick='showLoginPopup();' /></div>";
