...
<header>
	...
	if($noup=="COURSE"){
		echo "<td class='navButt'><a href='courseed.php' class='head__backanchor'><img src='../Shared/icons/Home.svg'><span class='head__backtext'>Back</span></a></td>";
	}else if($noup=="SECTION"){
		$cid=getOPG('cid');
		$coursevers=getOPG('coursevers');
		echo "<td class='navButt'><a href='sectioned.php?courseid=".$cid."&coursevers=".$coursevers."' class='head__backanchor'><img src='../Shared/icons/Home.svg'><span class='head__backtext'>Back</span></a></td>";
	}else{
				// None!
	}
