...
?>
       <?php
			...
			echo "<td class='navButt' id='theme-toggle'><div class='theme-toggle-nav' tabindex='0'><img src='../Shared/icons/ThemeToggle.svg' title='Toggle between dark mode' alt='an icon on a moon, which indicates dark mode and light mood'></div></td>";
              ...
              echo "        <img alt='files icon' id='editFiles' class='navButt' src='../Shared/icons/files_icon.svg'>";
							...
							echo "<div class='refresh menuButton tooltip'>";
								echo "<span id='refreshBTN' value='Refresh' href='#'>";
									echo "<img alt='refresh icon' title='Refresh github repo' id='refreshIMG' class='navButt' onclick='refreshGithubRepo(".$_SESSION['courseid'].",".isSuperUser($_SESSION['uid']).");resetGitFetchTimer(".isSuperUser($_SESSION['uid']).")' src='../Shared/icons/gitrefresh.svg'>";
								echo "</span>";
            	...
            	echo "<span id='refreshBTN' title='Download Github Repo' value='Refresh' href='#'>";
							...
							echo "<img alt ='Dark' class='burgerButt' title='Toogle between dark mode' src='../Shared/icons/ThemeToggle.svg'></>";
							// not working yet
