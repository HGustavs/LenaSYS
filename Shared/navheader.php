       ...
       <?php
			...
			if ($row !== false) {
				...
				if(checklogin() == false|| $_SESSION['uid'] == 0 || (isStudentUser($_SESSION['uid']))){
					...
					echo "<img alt ='Dark' class='navBurgerButt' src='../Shared/icons/ThemeToggle.svg' title='Press for dark mode'></>";
					echo "</a>";
					echo "</a>";
					echo"</div>";
					echo"</div>";					
			...
			echo "<td class='navButt' id='theme-toggle'><div class='theme-toggle-nav' tabindex='0'><img src='../Shared/icons/ThemeToggle.svg' title='Press for dark mode' alt='an icon on a moon, which indicates dark mode and light mood'></div></td>";
              ...
              echo "        <img alt='files icon' id='editFiles' class='navButt' src='../Shared/icons/files_icon.svg'>";
							...
							echo "<div class='refresh menuButton tooltip'>";
								echo "<span id='refreshBTN' value='Refresh' href='#'>";
									echo "<img alt='refresh icon' id='refreshIMG' class='navButt' onclick='refreshGithubRepo(".$_SESSION['courseid'].",".isSuperUser($_SESSION['uid']).");resetGitFetchTimer(".isSuperUser($_SESSION['uid']).")' src='../Shared/icons/gitrefresh.svg' title='Refresh github repo'>";
								echo "</span>";
