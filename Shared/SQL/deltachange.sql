...
*/
ALTER TABLE lenasys_user ADD COLUMN securityquestion VARCHAR(256) DEFAULT NULL;
ALTER TABLE lenasys_user ADD COLUMN requestedpasswordchange	TINYINT(1) UNSIGNED NOT NULL DEFAULT 0;
