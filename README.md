...
Make sure you have a working install of apache2 and other needed packages. Look at the wiki page for this at [Configuring web server for LenaSYS installation](https://github.com/HGustavs/LenaSYS/wiki/Configuring-web-server-for-LenaSYS-installation) or this [Setup for Windows VT25](https://github.com/HGustavs/LenaSYS/wiki/Setup-XAMPP-and-LenaSYS-for-WINDOWS-VT2025) for further information.
