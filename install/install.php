        ...
        if (isset($_POST["createDB"]) && $_POST["createDB"] == 'Yes') {
            ...
            if (isset($_POST["fillDB"]) && $_POST["fillDB"] == 'Yes' && $initSuccess) {
				...
				if (isset($_POST["contribution"])) {
					try {
						$completeQuery = "INSERT INTO `quiz` (`id`, `cid`, `autograde`, `gradesystem`, `qname`, `quizFile`, `qrelease`, `deadline`, `modified`, `creator`, `vers`, `qstart`, `jsondeadline`, `group`) VALUES (13, 3, 0, 1, 'Contribution', 'contribution', NULL, '2019-05-15 00:00:00', '2019-05-14 08:40:35', 2, '1337', NULL, NULL, 0);";
						$connection->query($completeQuery);
						
						$completeQuery = "INSERT INTO `listentries` (`lid`, `cid`, `entryname`, `link`, `kind`, `pos`, `creator`, `ts`, `code_id`, `visible`, `vers`, `comments`, `moment`, `gradesystem`, `highscoremode`, `rowcolor`, `groupID`, `groupKind`) VALUES (2037, 3, 'Contribution', '13', 3, 100, 2, '2019-05-14 08:42:25', NULL, 1, '1337', 'UNK', NULL, 0, 0, NULL, NULL, NULL);";
						$connection->query($completeQuery);
