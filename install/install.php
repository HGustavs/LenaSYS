            ...
            if (isset($_POST["fillDB"]) && $_POST["fillDB"] == 'Yes' && $initSuccess) {
				...
				if (isset($_POST["contribution"])) {
					try {
						...
						$completeQuery = "INSERT INTO `listentries` (`lid`, `cid`, `entryname`, `link`, `kind`, `pos`, `creator`, `ts`, `code_id`, `visible`, `vers`, `comments`, `moment`, `gradesystem`, `highscoremode`, `rowcolor`, `groupID`, `groupKind`) VALUES (2037, 3, 'Contribution', '13', 3, 100, 2, '2019-05-14 08:42:25', NULL, 0, '1337', 'UNK', NULL, 0, 0, NULL, NULL, NULL);";
						$connection->query($completeQuery);
