...
/* Insert test users */
-- No Course --
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (1010,'c92cober','Conny','Berg Czarnecki','19920404-4522',password('password'),'1','c92cober@student.his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (2020,'a87antal','Ann-Marie','Tallström','19871116-7384',password('password'),'1','a87antal@student.his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (3030,'a72ashal','Åsa','Hällsjö','19721224-5582',password('password'),'1','a72ashal@student.his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (4040,'a92albri','Alex','Bridgeman','19920404-0404',password('password'),'1','a92albri@student.his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (5050,'e93evkos','Eva','Koskinen','19930505-0505',password('password'),'1','e93evkos@student.his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (6060,'s94sveri','Sven','Eriksson','19940606-0606',password('password'),'1','s94sveri@student.his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (7070,'s92sveri','Sven','Eriksson','19920707-0707',password('password'),'1','s92sveri@student.his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (8080,'k90kakli','Karl','Klint','19900808-0808',password('password'),'1','k90kakli@student.his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (9090,'s91stcar','Stina','Carlsson','19910909-0909',password('password'),'1','s91stcar@student.his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (1111,'b94brbro','Brick','Brock','19941022-2925',password('password'),'1','b94brbro@student.his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (1212,'c94chcha','Chevy','Chase','19431008-6935',password('password'),'1','c43chcha@student.his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (1313,'h94haste','Hanna','Sten','19890708-2535',password('password'),'1','h89haste@student.his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (1414,'l94lewal','Leif','Wallberg','19890813-2435',password('password'),'1','l89lewal@student.his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (1515,'j94jojoh','Johan','Johansson','19870427-6635',password('password'),'1','j87jojoh@student.his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (1616,'a94anjoh','Anita','Johansson','19830617-6654',password('password'),'1','a83anjoh@student.his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (1717,'b94bejoh','Berit','Johansson','19900412-2554',password('password'),'1','b90bejoh@student.his.se','what is your mothers name?','maria');
-- DVSUG --
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer,class) VALUES (216,'a99marjo','Maria','Johansson','19990101-0001',password('password'),'a99marjo@student.his.se','what is your mothers name?','maria','DVSUG13h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer,class) VALUES (217,'a99erijo','Erik','Johansson','19990101-0002',password('password'),'a99erijo@student.his.se','what is your mothers name?','maria','DVSUG13h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer,class) VALUES (218,'a99annan','Anna','Andersson','19990101-0003',password('password'),'a99annan@student.his.se','what is your mothers name?','maria','DVSUG13h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer,class) VALUES (219,'a99laran','Lars','Andersson','19990101-0004',password('password'),'a99laran@student.his.se','what is your mothers name?','maria','DVSUG13h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer,class) VALUES (220,'a99karka','Karl','Karlsson','19990101-0005',password('password'),'a99karka@student.his.se','what is your mothers name?','maria','DVSUG13h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer,class) VALUES (231,'a99oloja','Olof','Jansson','19990101-0016',password('password'),'a99oloja@student.his.se','what is your mothers name?','maria','DVSUG13h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer,class) VALUES (232,'a99linja','Linnéa','Jansson','19990101-0017',password('password'),'a99linja@student.his.se','what is your mothers name?','maria','DVSUG13h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer,class) VALUES (233,'a99petha','Peter','Hansson','19990101-0018',password('password'),'a99petha@student.his.se','what is your mothers name?','maria','DVSUG13h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer,class) VALUES (234,'a99gunbe','Gunnar','Bengtsson','19990101-0019' ,password('password'),'a99gunbe@student.his.se','what is your mothers name?','maria','DVSUG13h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer,class) VALUES (235,'a99kerbe','Kerstin','Bengtsson','19990101-0020',password('password'),'a99kerbe@student.his.se','what is your mothers name?','maria','DVSUG13h');
-- WEBUG13h --
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer, class) VALUES (221,'a99marka','Margareta','Karlsson','19990101-0006',password('password'),'a99marka@student.his.se','what is your mothers name?','maria','WEBUG13h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer, class) VALUES (222,'a99elini','Elisabet','Nilsson','19990101-0007',password('password'),'a99elini@student.his.se','what is your mothers name?','maria','WEBUG13h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer, class) VALUES (223,'a99andni','Anders','Nilsson','19990101-0008',password('password'),'a99andni@student.his.se','what is your mothers name?','maria','WEBUG13h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer, class) VALUES (224,'a99evaer','Eva','Eriksson','19990101-0009',password('password'),'a99evaer@student.his.se','what is your mothers name?','maria','WEBUG13h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer, class) VALUES (225,'a99joher','Johan','Eriksson','19990101-0010',password('password'),'a99joher@student.his.se','what is your mothers name?','maria','WEBUG13h');
-- WEBUG14h --                                                                                                                           
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer, class) VALUES (226,'a99krila','Kristina','Larsson','19990101-0011',password('password'),'a99krila@student.his.se','what is your mothers name?','maria','WEBUG14h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer, class) VALUES (227,'a99perla','Per','Larsson','19990101-0012',password('password'),'a99perla@student.his.se','what is your mothers name?','maria','WEBUG14h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer, class) VALUES (228,'a99birol','Birgitta','Olsson','19990101-0013',password('password'),'a99birol@student.his.se','what is your mothers name?','maria','WEBUG14h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer, class) VALUES (229,'a99nilol','Nils','Olsson','19990101-0014',password('password'),'a99nilol@student.his.se','what is your mothers name?','maria','WEBUG14h');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,securityquestion,securityquestionanswer, class) VALUES (230,'a99karpe','Karin','Persson','19990101-0015',password('password'),'a99karpe@student.his.se','what is your mothers name?','maria','WEBUG14h');

/* Teachers */
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,creator,superuser,securityquestion,securityquestionanswer) VALUES (100,'stei','Joey','Stenhus','340101-0101','*15E4521DE818D9E7B318250FE7DCDA0419FA84AE','joey.s@his.se',0,1,'what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,email,creator,superuser,securityquestion,securityquestionanswer) VALUES (101,'brom','Martin','Brobygge','340101-1232','*15E4521DE818D9E7B318250FE7DCDA0419FA84AE','martin.b@his.se',0,1,'what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (4,'teacher1','Emma','Lindberg','19770101-1231',password('password'),'1','teacher1@his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (5,'teacher2','Lena','Carlsson','19770101-1232',password('password'),'1','teacher2@his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (6,'teacher3','Bo','Lindberg','19770101-1233',password('password'),'1','teacher3@his.se','what is your mothers name?','maria');
INSERT INTO user (uid,username,firstname,lastname,ssn,password,creator,email,securityquestion,securityquestionanswer) VALUES (7,'teacher4','Daniel','Magnusson','19770101-1234',password('password'),'1','teacher4@his.se','what is your mothers name?','maria');
