...
if(strcmp($opt,"GET")==0){
 	if(checklogin() && (hasAccess($_SESSION['uid'], $cid, 'w') || isSuperUser($_SESSION['uid']))) {
		...
		} else { // There weren't any applicable listentries for the specified lid and vers. 
			$data['feedback'] = 'There are no moments that are marked as Group seminar or Group dugga. There need to be at least one such moment for the specified course and course version for you to be able to assign users to groups.';
		}
