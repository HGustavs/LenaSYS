...
GRANT SELECT ON QSystemUser TO 'lasse'@'localhost';
...
GRANT SELECT ON logFailedUserLogins TO 'lasse'@'localhost';
GRANT SELECT ON logSuccessfulUserLogins TO 'lasse'@'localhost';
...
GRANT INSERT ON logFailedUserLogins TO 'lasse'@'localhost';
GRANT INSERT ON logSuccessfulUserLogins TO 'lasse'@'localhost';
...
GRANT SELECT ON logFailedUserLogins TO 'vigdis'@'localhost';
GRANT SELECT ON logSuccessfulUserLogins TO 'vigdis'@'localhost';
...
GRANT INSERT ON logFailedUserLogins TO 'vigdis'@'localhost';
GRANT INSERT ON logSuccessfulUserLogins TO 'vigdis'@'localhost';
...
GRANT UPDATE ON logFailedUserLogins TO 'vigdis'@'localhost';
GRANT UPDATE ON logSuccessfulUserLogins TO 'vigdis'@'localhost';
