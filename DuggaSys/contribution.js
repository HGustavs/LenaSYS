...
function renderCellForghContibTable(col, celldata, cellid) {
  ...
  if (col === 'weeks') {
    ...
    var i = 0;
    var ObjYear1 = Number(obj.weekStart.substr(0,4));
    var ObjYear2 = Number(obj.weekEnd.subtract(0,4));
    var ObjMonth1 = Number(obj.weekStart.substr(5,2));
    var ObjMonth2 = Number(obj.weekEnd.subtract(5,2));
    var ObjDay1 = Number(obj.weekStart.substr(8,2));
    var ObjDay2 = Number(obj.weekEnd.substr(8,2)); 
