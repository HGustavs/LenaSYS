...
function redrawtable()
{
    ...
    str+="<div id='horizhighlight' style='position:absolute;left:240px;top:50px;right:400px;bottom:0px;pointer-events:none;display:none;'></div>";
		...
		if (momtmp.length > 0){
				...
				str+="<th  id='header' class='rowno'></th><th class='result-header dugga-result-subheader' id='header0' onclick='toggleSortDir(0);'><div class='dugga-result-subheader-div' title='Aktiv'>Aktiv i kurs</div></th>"	
				for(var j=0;j<momtmp.length;j++){
