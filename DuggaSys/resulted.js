...
function process() {
	...
	dstr += "<div class='checkbox-dugga lo' style='border-bottom:1px solid #888;' ><input name='sortcol' type='radio' class='sortradio' onclick='sorttype(2)' value='0' id='sortcol0_2'><label class='headerlabel' for='sortcol0_2' >SSN</label></div>";
	dstr += "<div class='checkbox-dugga hi' ><input name='sortcol' type='radio' class='sortradio' onclick='sorttype(3)' value='0' id='sortcol0_3'><label class='headerlabel' for='sortcol0_3' >Class</label></div>";
	dstr += "<div class='checkbox-dugga lo' style='border-bottom:1px solid #888;' ><input name='sortcol' type='radio' class='sortradio' onclick='sorttype(4)' value='0' id='sortcol0_4'><label class='headerlabel' for='sortcol0_4' >Teacher</label></div>";
    ...
    if(j % 2 == 0){
      ...
      dstr += "<div class='lo ";
		...
		dstr += "checkbox-dugga checknarrow ";
