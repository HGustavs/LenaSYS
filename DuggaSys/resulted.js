...
{			
    ...
    dstr+="<div class='checkbox-dugga' style='border-bottom:1px solid #888'><input type='checkbox' class='headercheck' name='sortdir' value='1' id='sortdir1'><label class='headerlabel' for='sortdir0'>Only pending</label><input name='sortdir' type='checkbox' class='headercheck' value='-1' id='sortdir-1'><label class='headerlabel' for='sortdir-1'>Hide Teacher</label></div>";
