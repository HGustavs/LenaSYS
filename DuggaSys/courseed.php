...
<div id='newCourse' class='loginBoxContainer' style='display:none;'>
    <div class='loginBox DarkModeBackgrounds DarkModeText' style='width:464px;  overflow:hidden;'>
    		...
    		<div style='padding:5px;'>
    			<input class='submit-button' id="createCourse" type='button' value='Create' disabled title='Create course' onclick="validateForm('newCourse'); showCreateVersion()" />
    		</div>
      </div>
	</div>
...
<!-- New Version Dialog START -->
    	...
    	<div class='loginBox DarkModeBackgrounds DarkModeText' style='width:464px; overflow:hidden;'>
			...
			<div style='padding:5px;'>
				<div class='inputwrapper'><span>Version ID:</span><input onkeyup="versionValidateForm('newCourseVersion', 'submitCourseMotd');" class='textinput' type='text' id='cversid' placeholder='Version ID' maxlength='8'/></div>
				...
				<div class='inputwrapper'><span>Version Name:</span><input onkeyup="versionValidateForm('newCourseVersion', 'submitCourseMotd'); " class='textinput' type='text' id='versname' placeholder='Version Name' /></div>
				...
				<div class='inputwrapper'><span>Start Date:</span><input onchange="versionValidateForm('newCourseVersion', 'submitCourseMotd'); " class='textinput' type='date' id='startdate' value='' /></div>
				<div class='inputwrapper'><span>End Date:</span><input onchange="versionValidateForm('newCourseVersion', 'submitCourseMotd'); " class='textinput' type='date' id='enddate' value='' /></div>
				...
				<div class='inputwrapper'><span>MOTD:</span><input onkeyup="versionValidateForm('newCourseVersion', 'submitCourseMotd'); " class='textinput' type='text' id='vmotd' placeholder='MOTD' value='' /></div>
			...
			<div style='padding:5px;'>
				<input id='submitCourseMotd' class='submit-button' type='button' value='Create' disabled title='Create new version' onclick="validateVersion('newCourseVersion')" />
			</div>
		</div>
	</div>
