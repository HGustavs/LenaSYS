...
function renderCell(col, celldata, cellid) {
    ...
    if (col == "trashcan") {
        if (obj.showtrashcan) {
            str = "<span class='iconBox trashcanTab' tabindex='0'><img alt='delete file icon' id='dorf' title='Delete file' class='trashcanIcon' src='../Shared/icons/Trashcan.svg' ";
        ...
        if (obj.extension == "md" || obj.extension == "txt" || obj.extension == "html") {
            str = "<span class='iconBox showeditorTab' tabindex='0'><img alt='edit file icon' id='dorf'  title='Edit file'  class='markdownIcon' src='../Shared/icons/markdownPen.svg' ";
