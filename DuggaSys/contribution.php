...
<body onload="loadContribFormLocalStorage()">
	...
	<div id='commitDiv' style=' position: sticky; background: #f5e7ff;box-shadow: 1px 1px 6px rgba(0, 0, 0, 0.6); border-radius: 5px; width:500px; height: 500px; white-space: nowrap; display:none; top: 15px; margin-left: 50px; z-index: 100;'></div>
	...
	<div id="accountRequests-pane" class="hide-accountRequests-pane" onmousedown='mdown(event)'> <!-- Yellow menu on right side of screen -->
	<div id="accountRequests-pane-button" onclick="toggleOptionsPane();"><span id='optmarker'>Account requests</span>
        </div>
	</div>
