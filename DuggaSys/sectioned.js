      ...
      for (i = 0; i < data['entries'].length; i++) {
        ...
        if (itemKind === 3 || itemKind === 4) {
          ...
          if (itemKind === 3) {
            ...
            str += "<div class='dragbleArea'><img style='width: 53%;' alt='pen icon dugga' src='../Shared/icons/select.png'></div>";
            ...
            str += "<div id='selectionDragI"+item['lid']+"' class='dragbleArea'><img style='width: 53%;' alt='pen icon dugga' src='../Shared/icons/select.png'></div>";
        ...
        if (itemKind === 0) {
          ...
          str += "<td style='background-color: #614875;' class='LightBox" + hideState + "'>";
          str += "<div id='selectionDragI"+item['lid']+"' class='dragbleArea'><img alt='pen icon dugga' style='width: 53%;' src='../Shared/icons/select.png'></div>";
          str += `<td class='section item${hideState}' placeholder='${momentexists}'id='I${item['lid']}' style='cursor:pointer;' `;
          kk = 0;

        } else if (itemKind === 2) {
          str += "<td class='LightBox" + hideState + "'>";
          str += "<div class='dragbleArea'><img alt='pen icon dugga' style='width: 53%;' src='../Shared/icons/select.png'></div>";
