      ...
      if (retdata['writeaccess']) {
       ...
       /*if (itemKind === 1 && data['writeaccess'] || data['studentteacher']) {
        ...
        if (data['writeaccess'] || data['studentteacher']) {
          ...
          str += "<img style='filter: brightness(50%);' alt='settings icon'  tabIndex='0' id='dorf' title='Settings' class='settingIconTab' src='../Shared/icons/Cogwheel.svg' ";
        ...
        if (data['writeaccess'] || data['studentteacher']) {
          str += `<td style='width:32px;' class='${makeTextArray(itemKind, ["header", "section",
          "code", "test", "moment", "link", "group", "message"])} ${hideState}'>`;
          str += `<img style='filter: brightness(50%);' class="traschcanDelItemTab" alt='trashcan icon' tabIndex="0" id='dorf' title='Delete item' class=''
