...
// Retrieve start and end dates for a version, if there are such, else set to null
      ...
      str+="<li class='contribution'><button class='submit-button menuButton contribution' onclick='closeWindows(); changeURL(\"stats.php?cid="+querystring['courseid']+"&coursevers="+querystring['coursevers']+"\")'>Contribution</button></li>";
