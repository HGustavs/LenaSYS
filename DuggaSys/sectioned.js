      ...
      for (i = 0; i < data['entries'].length; i++) {
        ...
        if (itemKind === 0) {
          ...
          if (isLoggedIn) {
            ...
            str += "<td style='background-color: #614875;' class='LightBox" + hideState + "'>";
            str += "<div id='selectionDragI" + item['lid'] + "' class='dragbleArea'><img alt='pen icon dugga' title='Press and drag to arrange' style='width: 53%;padding-left: 6px;padding-top: 5px;' src='../Shared/icons/select.png'></div>";
          }
