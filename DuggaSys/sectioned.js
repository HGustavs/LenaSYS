      ...
      for (i = 0; i < data['entries'].length; i++) {
          ...
          if (retdata['writeaccess']) {
            if (itemKind === 3) {
              if (isLoggedIn) {
                ...
                str += "<div class='dragbleArea'><img style='width: 53%; padding-left: 6px;padding-top: 5px;' alt='pen icon dugga' title='Press to arrange' src='../Shared/icons/select.png'></div>";
              }
            } else if (itemKind === 4) {
              if (isLoggedIn) {
                str += "<td style='background-color: #614875;' class='LightBox" + hideState + "'  >";
                str += "<div id='selectionDragI" + item['lid'] + "' class='dragbleArea'><img style='width: 53%; padding-left: 6px;padding-top: 5px;' alt='pen icon dugga' title='Press to arrange' src='../Shared/icons/select.png'></div>";
              }
            }
            str += "</td>";
          }
        ...
        if (itemKind === 0) {
          ...
          if (isLoggedIn) {
            ...
            str += "<td style='background-color: #614875;' class='LightBox" + hideState + "'>";
            str += "<div id='selectionDragI" + item['lid'] + "' class='dragbleArea'><img alt='pen icon dugga' style='width: 53%;padding-left: 6px;padding-top: 5px;' title='Press to arrange' src='../Shared/icons/select.png'></div>";
          }
          ...
          if (retdata['writeaccess']) {
            str += "<td class='LightBox" + hideState + "'>";
            str += "<div ><img class='iconColorInDarkMode' alt='pen icon dugga' title='Press to arrange' src='../Shared/icons/PenT.svg'></div>";
          }
          ...
          str += "<div ><img alt='pen icon dugga' title='Press to arrange' src='../Shared/icons/list_docfiles.svg'></div>";
