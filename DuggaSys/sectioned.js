...
// Retrieve start and end dates for a version, if there are such, else set to null
      ...
      str+="<li class='analysis'><button class='submit-button menuButton analysis' onclick='closeWindows(); changeURL(\"stats.php?cid="+querystring['courseid']+"&coursevers="+querystring['coursevers']+"\")' title='Access analysis page'>Analysis</button></li>";
