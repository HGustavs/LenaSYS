<style>	
	...
	@keyframes loginFail {
		...
		75% {
			background-color: rgba(72, 163, 62, 0.2);
		}
		100% {
			background-color: rgba(255,255,255,1);
		}
...
<div id='loginBox' class='loginBoxContainer' style="display:flex;">
        <div id='login' class='loginBox' style="display:none"> <!-- Initial login screen display -->
    ...
    <div id='newpassword' class='newpassword' style="display:">
			<div class='loginBoxheader'>
