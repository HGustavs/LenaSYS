...
<body onload="setup();">
	...
	<div id='groupSection' class='loginBox' style='width:285px;display:none;'>
		...
		<div style='padding:5px;'>
			<div id='inputwrapper-name' class='inputwrapper'><span>Name:</span><input style='float:none; margin-left: 5px;' type='text' class='textinput' id='groupname' placeholder='Name' /></div>
		</div>
		<div style='padding:5px;'>
