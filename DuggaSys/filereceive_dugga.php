...
if($ha){
		...
		if(!file_exists($currcvd."/submissions")) {
				if(!mkdir($currcvd."/submissions",0755,true)) {
		...
		if(!file_exists ($currcvd."/submissions/".$cid)){
				if(!mkdir($currcvd."/submissions/".$cid,0755,true)){
		...
		if(!file_exists ($currcvd."/submissions/".$cid."/".$vers)){
				if(!mkdir($currcvd."/submissions/".$cid."/".$vers,0755,true)){
		...
		if(!file_exists ($currcvd."/submissions/".$cid."/".$vers."/".$duggaid)){
				if(!mkdir($currcvd."/submissions/".$cid."/".$vers."/".$duggaid,0755,true)){
