...
const enterKey = defaultEnterKey;
const shiftKey = defaultShiftKey;
const ctrlKey = defaultCtrlKey;
const altKey = defaultAltKey;
const escapeKey = defaultEscapeKey;
const spacebarKey = defaultSpacebarKey;
const leftArrow = defaultLeftArrow;
const upArrow = defaultUpArrow;
const rightArrow = defaultRightArrow;
const downArrow = defaultDownArrow;
const deleteKey = defaultDeleteKey;
const key0 = defaultKey0;
const key1 = defaultKey1;
const key2 = defaultKey2;
const key4 = defaultKey4;
const aKey = defaultAKey;
const cKey = defaultCKey;
const dKey = defaultDKey;
const eKey = defaultEKey;
const fKey = defaultFKey;
const lKey = defaultLKey;
const mKey = defaultMKey;
const nKey = defaultNKey;
const oKey = defaultOKey;
const rKey = defaultRKey;
const tKey = defaultTKey;
const vKey = defaultVKey;
const zKey = defaultZKey;
const yKey = defaultYKey;
const xKey = defaultXKey;
const windowsKey = defaultWindowsKey;
const num1 = defaultNum1;
const num2 = defaultNum2;
const lessThanKey = defaultLessThanKey;
