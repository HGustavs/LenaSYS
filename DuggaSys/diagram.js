        ...
        str += `<div id="${element.id}" 
                     ...
                     onmouseleave='mouseLeave();'>
                        <svg width="100%" height="100%"
                             ...
                             xmlns="http://www.w3.org/2000/svg"
                             xml:space="preserve"
                             style="fill:${element.fill};fill-rule:nonzero;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
                            ...
                            <g transform="matrix(1.06667,0,0,1.06667,-3.46667,-3.46667)">
                                <circle style="fill:${element.fill}" cx="14.5" cy="14.5" r="5.5"/>
                            </g>
                        </svg>
                </div>`;
    }
