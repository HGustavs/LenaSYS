   ...
   if (line.ctype == "BT"){
    ...
    if ((felem.type == 'SD') || (telem.type == 'SD')){
        if (line.kind == "Recursive"){
            ...
            str += `<line id='${line.id}-line3' class='lineColor' x1='${cornerX + x1Offset + 10}' y1='${cornerY + y1Offset}' x2='${endX + x1Offset + 10}' y2='${cornerY + y1Offset}' stroke='${lineColor}' stroke-width='${strokewidth * zoomfact}'/>`;
