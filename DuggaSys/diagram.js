        ...
        switch (line.startIcon) {
            ...
            case UMLLineIcons.TRIANGLE:
                if (line.ctype == 'TB') {
                    ...
                    str += `<polyline id='${line.id+"IconOne"}' class='diagram-umlicon-triangle' points='${fx - 10 * zoomfact} ${fy + 19 * zoomfact},${fx} ${fy},${fx + 10 * zoomfact} ${fy + 20 * zoomfact},${fx - 10 * zoomfact} ${fy + 20 * zoomfact}' stroke='${lineColor}' stroke-width='${strokewidth}'/>`;
                }
                else if (line.ctype == 'LR') {
