...
var defaults = {
    ...
    sequenceActorAndObject: {name: "name", kind: "sequenceActorAndObject", fill: "#FFFFFF", stroke: "#000000", width: 100, height: 150, type: "sequence" } // UML Super State.
}
...
function drawElement(element, ghosted = false)
{
    ...
    var sequenceActorDisplay; // used for switching between actor and object in sequence diagram.
    var sequenceObjectDisplay;
