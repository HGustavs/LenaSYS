...
function drawSelectionBox(str)
{
    ...
    if ((context.length != 0 || contextLine.length != 0) && mouseMode != mouseModes.EDGE_CREATION) {
        ...
        str += `<line x1='${deleteBtnX + 2}' y1='${deleteBtnY + 2}' x2='${deleteBtnX + deleteBtnSize - 2}' y2='${deleteBtnY + deleteBtnSize - 2} class='BlackthemeColor' style='stroke:rgb(0,0,0);stroke-width:2'/>`;
        str += `<line x1='${deleteBtnX + 2}' y1='${deleteBtnY + deleteBtnSize - 2}' x2='${deleteBtnX + deleteBtnSize - 2}' y2='${deleteBtnY + 2} class='BlackthemeColor' style='stroke:rgb(0,0,0);stroke-width:2'/>`;
    }
    return str; 
}
