...
var defaults = {
    ...
    UMLInitialState: {name: "UML Initial State", kind: "UMLInitialState", fill: "#FFFFFF", stroke: "#000000", width: 60, height: 60, type: "SD" }, // UML Initial state.
    UMLFinalState: {name: "UML Final State", kind: "UMLFinalState", fill: "#FFFFFF", stroke: "#000000", width: 60, height: 60, type: "SD" }, // UML Final state.
                     ...
                     onmouseleave='mouseLeave();'>
                        <svg width="100%" height="100%" 
                            ...
                            <g  transform="matrix(1.14286,0,0,1.14286,-6.85714,-2.28571)">
                                <circle stroke='${element.stroke}' cx="16.5" cy="12.5" r="10.5"/>
                            </g>
                        </svg>
                </div>`;
    }
        ...
        str += `<div id="${element.id}" 
                     ...
                     onmouseleave='mouseLeave();'>
                        <svg width="100%" height="100%"
                             ...
                             style="fill:${element.fill};fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
                            <g>
                                <path stroke='${element.stroke}' d="M12,-0C18.623,-0 24,5.377 24,12C24,18.623 18.623,24 12,24C5.377,24 -0,18.623 -0,12C-0,5.377 5.377,-0 12,-0ZM12,2C17.519,2 22,6.481 22,12C22,17.519 17.519,22 12,22C6.481,22 2,17.519 2,12C2,6.481 6.481,2 12,2Z"/>
                                <circle stroke='${element.stroke}' transform="matrix(1.06667,0,0,1.06667,-3.46667,-3.46667)" cx="14.5" cy="14.5" r="5.5"/>
                            </g>
                        </svg>
                </div>`;
    }
