   ...
   if (line.ctype == "BT"){
    ...
    if ((felem.type == 'SD') || (telem.type == 'SD')){
        if (line.kind == "Recursive"){
            ...
            document.getElementById(`${line.id}IconOne`).remove();
            ...
            str += `<polyline id='${line.id+"IconOne"}' class='diagram-umlicon-darkmode-sd' points='${endX + x1Offset - 5 * zoomfact},${endY + y1Offset - 40 * zoomfact},${endX + x1Offset},${endY + y1Offset - 50 * zoomfact},${endX + x1Offset + 5 * zoomfact},${endY + y1Offset - 40 * zoomfact},${endX + x1Offset},${endY + y1Offset - 30 * zoomfact}' stroke='${lineColor}' stroke-width='${strokewidth * zoomfact}'/>`;
        }
    }
