...
var defaults = {
    ...
    sequenceLifeLine: {name: "Life Line", kind: "sequenceLifeLine", fill: "#FFFFFF", stroke: "#000000", width: 100, height: 100, type: "sequence" } // UML Super State.
}
    ...
    //sequence life line
        ...
        str += `<path class="text" 
            d="M${(boxw/2)+linew},${(boxh/4)+linew}
                ...
                m-${(boxw/4)},0
                v${boxh/3}
                l${boxw/2},${boxh-(boxh/4)}
                m${(boxw/2)*-1},${(boxh-(boxh/4))*-1}
                l${(boxw/2)*-1},${boxh-(boxh/4)}
            "
            stroke-width='${linew}'
            stroke='${element.stroke}'
            fill='transparent'
