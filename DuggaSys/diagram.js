    ...
    if (felem.type != 'ER' || telem.type != 'ER') {
        ...
        switch (line.startIcon) {
            ...
            case SDLineIcons.ARROW:
                if (line.ctype == 'TB') {
                    str += `<polyline id='${line.id+"IconOne"}' class='diagram-umlicon-darkmode-sd' points='${fx - 10 * zoomfact} ${fy - 20 * zoomfact},${fx} ${fy + 4 * zoomfact},${fx + 10 * zoomfact} ${fy - 20 * zoomfact},${fx - 10 * zoomfact} ${fy - 20 * zoomfact}' stroke='${lineColor}' stroke-width='${strokewidth}'/>`;
                }
                else if(line.ctype == 'BT'){
        ...
        switch (line.endIcon) {
            ...
            case SDLineIcons.ARROW:
                if (line.ctype == 'BT') {
                    ...
                    str += `<polyline id='${line.id+"IconOne"}' class='diagram-umlicon-darkmode-sd' points='${tx - 10 * zoomfact} ${ty + 20 * zoomfact},${tx} ${ty - 4 * zoomfact},${tx + 10 * zoomfact} ${ty + 20 * zoomfact},${tx - 10 * zoomfact} ${ty + 20 * zoomfact}' stroke='${lineColor}' stroke-width='${strokewidth}'/>`;
                }
                else if (line.ctype == 'RL') {
