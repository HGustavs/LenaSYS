...
function drawElement(element, ghosted = false)
{
    ...
    // Check if element is SDState
        ...
        if (elemAttri != 0) {
            //svg for background
            str += `<svg id='SD-Corner' width='${boxw}' height='${boxh / 2 + (boxh * elemAttri / 2)}' style='border-bottom-left-radius: ${boxh / 2}px; border-bottom-right-radius: ${boxh / 2}px;' >`;
            ...
            //svg for background
            str += `<svg id='SD-Corner' width='${boxw}' height='${boxh / 2 + (boxh / 2)}' style='border-bottom-left-radius: ${boxh / 2}px; border-bottom-right-radius: ${boxh / 2}px;'>`;
        ...
        str += `<div style='margin-top: ${-8 * zoomfact}px;'>`;
        if (elemFunc != 0) {
            const sdCorner = document.getElementById("SD-Corner");
            sdCorner.style.border-bottom-right-radius == null;
            sdCorner.style.border-bottom-right-radius == 0;
