    ...
    switch (pointerState) {
        ...
        case pointerStates.CLICKED_NODE:
            ...
            if (startNodeLeft && (startWidth + (deltaX / zoomfact)) > minWidth) {
                ...
                stateMachine.save(StateChangeFactory.ElementMovedAndResized([elementData.id], 0, elementData.y, 0, elementData.height), StateChange.ChangeTypes.ELEMENT_MOVED_AND_RESIZED);
            }
