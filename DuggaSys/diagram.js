   ...
   if (line.ctype == "BT"){
    ...
    if ((felem.type == 'SD') || (telem.type == 'SD')){
        if (line.kind == "Recursive"){
            ...
            str += `<line id='${line.id}-line3' class='lineColor' x1='${cornerX + x1Offset}' y1='${cornerY + y1Offset + 10}' x2='${endX + x1Offset}' y2='${cornerY + y1Offset + 10}' stroke='${lineColor}' stroke-width='${strokewidth * zoomfact}'/>`;
