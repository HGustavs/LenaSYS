...
function drawElement(element, ghosted = false)
{
    ...
    if (element.kind == "UMLEntity") { 
        ...
        str += `<div id="${element.id}" 
                    ...
                    <rect x='${linew}' y='${linew}' width='${boxw-(linew*2)}' height='${boxw-(linew*2)}' fill="none" fill-opacity="0" stroke='${nonFilledElementPartStrokeColor}' stroke-width='${linew}' rx="20"/>
    ...
    // Sequence activation 
        ...
        str += `<rect x='${linew}' y='${linew}' width='${boxw - (linew*2)}' height='${boxh - (linew*2)}' rx='${sequenceCornerRadius*2}' stroke-width='${linew}' stroke='${element.stroke}' fill='${element.fill}'/>`;
        str += `</svg>`;
    }
