        ...
        switch (line.startIcon) {
            ...
            case UMLLineIcons.TRIANGLE:
                if (line.ctype == 'TB') {
                    ...
                    str += `<polyline id='${line.id+"IconOne"}' class='diagram-umlicon-triangle' points='${fx - 10 * zoomfact} ${fy + 12 * zoomfact},${fx} ${fy - 1 * zoomfact},${fx + 10 * zoomfact} ${fy + 20 * zoomfact},${fx - 10 * zoomfact} ${fy + 20 * zoomfact}' stroke='${lineColor}' stroke-width='${strokewidth}'/>`;
                }
                else if (line.ctype == 'LR') {
