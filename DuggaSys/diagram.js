        ...
        switch (line.startIcon) {
            ...
            case UMLLineIcons.TRIANGLE:
                if (line.ctype == 'TB') {
                    ...
                    str += `<polyline id='${line.id+"IconOne"}' class='diagram-umlicon-triangle' points='${fx - 10 * zoomfact} ${fy + 18 * zoomfact},${fx} ${fy - 1 * zoomfact},${fx + 10 * zoomfact} ${fy + 18 * zoomfact},${fx - 10 * zoomfact} ${fy + 18 * zoomfact}' stroke='${lineColor}' stroke-width='${strokewidth}'/>`;
                }
                else if (line.ctype == 'LR') {
                    str += `<polyline id='${line.id+"IconOne"}' class='diagram-umlicon-triangle' points='${fx - 18 * zoomfact} ${fy - 10 * zoomfact},${fx + 1 * zoomfact} ${fy},${fx - 18 * zoomfact} ${fy + 10 * zoomfact},${fx - 18 * zoomfact} ${fy - 10 * zoomfact}' stroke='${lineColor}' stroke-width='${strokewidth}'/>`;
                }
                else if (line.ctype == 'RL') {
