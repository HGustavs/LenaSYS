   ...
   if (line.ctype == "BT"){
    ...
    if ((felem.type == 'SD') || (telem.type == 'SD')){
        if (line.kind == "Recursive"){
            ...
            str += `<polygon id='${line.id+"IconOne"}' class='diagram-umlicon-darkmode-sd' points='${endX + x1Offset - 5 * zoomfact},${endY + y1Offset - 40 * zoomfact},${endX + x1Offset},${endY + y1Offset - 30 * zoomfact},${endX + x1Offset + 5 * zoomfact},${endY + y1Offset - 40 * zoomfact}' fill='${lineColor}'/>`;
        }
    }
