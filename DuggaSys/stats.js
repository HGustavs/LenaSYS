...
{
    var vid=$("#vid").val();
    if(confirm("Do you really want to delete this Variant?")) AJAXService("DELVARI",{cid:querystring['cid'],vid:vid,coursevers:querystring['coursevers']},"STATS");
...
function toggleVariant()
{
    ...
    if ($("#toggleVariantButton").val()==="Disable") {
        if(confirm("Do you really want to disable this Variant?")) AJAXService("TOGGLEVARI",{cid:querystring['cid'],vid:vid,disabled:"1",coursevers:querystring['coursevers']},"STATS");
    } else {
        if(confirm("Do you really want to enable this Variant?")) AJAXService("TOGGLEVARI",{cid:querystring['cid'],vid:vid,disabled:"0",coursevers:querystring['coursevers']},"STATS");
    }
    $("#editVariant").css("display","none");
}
...
{
    AJAXService("ADDVARI",{cid:cid,qid:qid,coursevers:querystring['coursevers']},"STATS");
}
...
function updateVariant()
{
    ...
    AJAXService("SAVVARI",{cid:querystring['cid'],vid:vid,variantanswer:answer,parameter:parameter,coursevers:querystring['coursevers']},"STATS");
}
...
{
    AJAXService("ADDUGGA",{cid:querystring['cid'],coursevers:querystring['coursevers']},"STATS");
}
...
function updateDugga()
{
    ...
    AJAXService("SAVDUGGA",{cid:querystring['cid'],qid:did,nme:nme,autograde:autograde,gradesys:gradesys,template:template,release:release,deadline:deadline,coursevers:querystring['coursevers']},"STATS");
}
...
function returnedDugga(data)
{
    ...
    if (data['files'].length > 0) {
        ...
        str+="<tr><th class='first'>Name</th><th>Autograde</th><th>Gradesys</th><th>Template</th><th>Release</th><th>Deadline</th><th>Bonafide</th><th style='width:30px'></th><th style='width:30px' class='last'></th></tr>";
...
function changename(didd,num)
{
    ...
    AJAXService("UPDATEDNAME",{cid:querystring['cid'],qid:did,nme:nme,coursevers:querystring['coursevers']},"STATS");
}
function changeauto(didd,num)
{
    ...
    AJAXService("UPDATEAUTO",{cid:querystring['cid'],qid:did,autograde:autograde,coursevers:querystring['coursevers']},"STATS");
}
function changegrade(didd,num)
{
    ...
    AJAXService("UPDATEGRADE",{cid:querystring['cid'],qid:did,gradesys:gradesys,coursevers:querystring['coursevers']},"STATS");
...
function changefile(didd,num)
{
    ...
    AJAXService("UPDATETEMPLATE",{cid:querystring['cid'],qid:did,template:template,coursevers:querystring['coursevers']},"STATS");
}
...
function changeparam(vidd,num)
{
    ...
    AJAXService("SAVVARIPARA",{cid:querystring['cid'],vid:vid,parameter:parameter,coursevers:querystring['coursevers']},"STATS");
}
function changeanswer(vidd,num)
{
    ...
    AJAXService("SAVVARIANSWER",{cid:querystring['cid'],vid:vid,variantanswer:answer,coursevers:querystring['coursevers']},"STATS");
}
