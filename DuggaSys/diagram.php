    ...
    <div id="options-pane" class="hide-options-pane"> <!-- Yellow menu on right side of screen -->
        ...
        <div id ="fieldsetBox">
            ...
            <fieldset class='options-fieldset options-section'>
                ...
                <button id="a4TemplateToggle" class="saveButton" style="background-color: transparent; border:#614875; border-width:3px; border-style:solid; color:#614875;" onclick="toggleA4Template()">A4 template</button><br><br>
