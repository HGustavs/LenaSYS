...
<body onload="initializeCanvas(); Symbol(); canvasSize(); loadDiagram(); debugMode(); updateGraphics(); initToolbox();">
    ...
    <div id="content">
        <div id="buttonDiv">
                ...
                <div id="diagram-toolbar" class="application-toolbar-wrap">
                    ...
                    <div class='application-toolbar'>
                        ...
                        <div class="toolbar-drawer">
                            <div class="tooltip"><button id='linebutton' onclick='lineMode(), linebutton_selected();' class='diagram_option_button, unpressed'>
						<span class="tooltiptext">Create Line</span><img src="../Shared/icons/diagram_create_line.svg" height="30" width="40"></button></div>
                        </div>
                        <h4 class="label">Create</h4>
                        <div class="toolbar-drawer">
                           <div class="tooltip"><button id='attributebutton' onclick='attrMode(), attributebutton_selected();' class='diagram_option_button, unpressed'>
						<span class="tooltiptext">Create Attribute</span><img src="../Shared/icons/diagram_create_attribute.svg" height="30" width="40"></button></div>
			
						<div class="tooltip"><button id='entitybutton' onclick='entityMode(), entitybutton_selected();' class='diagram_option_button, unpressed'>
						<span class="tooltiptext">Create Entity</span><img src="../Shared/icons/diagram_create_entity.svg" height="30" width="40"></button></div>
			
						<div class="tooltip"><button id='relationbutton' onclick='relationMode(), relationbutton_selected();' class='diagram_option_button, unpressed'>
						<span class="tooltiptext">Create Relation</span><img src="../Shared/icons/diagram_create_relation.svg" height="30" width="40"></button></div>
            ...
            -->
			  <div class="tooltip"><button id='moveButton' class='diagram_option_button, unpressed'  style='right: 0; position: fixed; margin-right: 30px; margin-top:-10px'>
			<span class="tooltiptext">Start Moving</span><img src="../Shared/icons/diagram_move_arrows.svg" height="20" width="20"></button><br></div>
