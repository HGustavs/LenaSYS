...
<body style="overflow: hidden;">
    ...
    <!-- The FAB-btn for the diagram.php, STARTS HERE!-->
      ...
      <ol class="fab-btn-list" style="margin-bottom: 60px; padding:0;">
          <button id="check" class="btn-floating fab-inner diagramIcons" style="display: none;" type="button">
          <img class="icon-fit" src="../Shared/icons/LookingGlass.svg" alt="Check"/>
          </button>  
  
          <button id="loadlLoad" class="btn-floating fab-inner diagramIcons" style="display: none;" type="button">
          <img class="icon-fit" src="../Shared/icons/diagram_load_icon.svg" alt="Load diagram"/>
          </button>  
  
          <button id="localSaveAs" class="btn-floating fab-inner diagramIcons" style="display: none;" type="button">
          <img class="icon-fit" src="../Shared/icons/diagram_save_as_icon.svg" alt="Save as diagram"/>
          </button>  
  
          <button id="localSave"  class="btn-floating fab-inner diagramIcons" style="display: none;" type="button">
