...
<body style="overflow: hidden;">
    ...
    <div id="diagram-toolbar">
        ...
        <fieldset id="localLoadField">
            ...
            <div class="placementTypeBoxIcons diagramIcons toolbarMode" id="elementPlacement17" onclick="togglePlacementType(17); setElementPlacementType(17); setMouseMode(2);">
