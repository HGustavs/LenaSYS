    ...
    <div id="svggrid" style="z-index:-11">
        <svg id="svgbacklayer">
            ...
            <pattern id="grid" width="100" height="100" patternUnits="userSpaceOnUse">
                ...
                <path d="M 100 0 L 0 0 0 100" fill="none" stroke="gray" stroke-dasharray="0.9 0.9" stroke-width="3"/>
            </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#grid)" />
            <line id="origoX" x1="0%" y1="100" x2="100%" y2="100" style="stroke:rgb(171, 171, 171);stroke-width:5;"/>
            <line id="origoY" x1="100" y1="0%" x2="100" y2="100%" style="stroke:rgb(171, 171, 171);stroke-width:5;"/>
        </svg>  
    </div>
    <!-- A4 template -->
