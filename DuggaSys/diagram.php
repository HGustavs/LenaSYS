                ...
                <div>
                    ...
                    <div id="diagramPopOut">  
                        <div id="togglePlacementTypeBox11" class="togglePlacementTypeBox togglePlacementTypeBoxRI">
                            <div class="diagramIcons toolbarMode" onclick='togglePlacementType(1,0); setElementPlacementType(11); setMouseMode(2);'>
                            ...
                            <div class="diagramIcons toolbarMode" onclick='togglePlacementType(5,0); setElementPlacementType(11); setMouseMode(2);'>
