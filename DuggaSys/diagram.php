    ...
    <div id="options-pane" class="hide-options-pane"> <!-- Yellow menu on right side of screen -->
        ...
        <div id ="fieldsetBox">
            ...
            <fieldset class='options-fieldset options-section'>
                ...
                <button id="a4TemplateToggle" class="saveButton" style="background-color: transparent;" style="border: 3px solid #614875;" style="color: #614875;" onclick="toggleA4Template()">A4 template</button><br><br>
