                ...
                <div>
                    ...
                    <div id="diagramPopOut">  
                        <div id="togglePlacementTypeBox11" class="togglePlacementTypeBox togglePlacementTypeBoxRI">
                            <div class="SEButton toolbarMode" onclick='togglePlacementType(1,1); setElementPlacementType(11); setMouseMode(2);'>
                            ...
                            <div class="SEButton toolbarMode" onclick='togglePlacementType(5,1); setElementPlacementType(11); setMouseMode(2);'>
