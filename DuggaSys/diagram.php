                ...
                <div id="diagram-toolbar" class="application-toolbar-wrap" onmousedown="">
                    ...
                    <div class="menu-drop-down">
                        ...
                        <div class="drop-down">
                            ...
                            <div class="drop-down-item">
                                <div id="a4-singleA4-item" class="drop-down-item-disabled">
                                    <span class="drop-down-option" onclick='toggleSingleA4(event);'><img src="../Shared/icons/Arrow_down_right.png">Toggle Single A4</span>
                                </div>
                            </div>
                            <div class="drop-down-item">
