...
<body onload="initializeCanvas(); Symbol(); canvasSize(); loadDiagram(); debugMode(); updateGraphics();">
    ...
    <div id="content">
        ...
        <div id="consoleDiv" style='position: relative;'>
            ...
            <div id='valuesCanvas' style='position: absolute; left: 2px; bottom: 5px; -webkit-touch-callout: none; -webkit-user-select: none; -khtml-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: default;'></div>
