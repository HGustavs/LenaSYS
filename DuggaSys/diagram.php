...
<body onload="initcanvas(); Symbol();">
	...
	<div id="content">
	      ...
	      <button onclick="classmode();">Create Class</button><button onclick="attrmode();">Create Attribute</button><button onclick="linemode();">Create Line</button><br><button onclick="entitymode();">Create Entity</button><button onclick="figuremode();">Create Figure</button><br>
