		...
		if(checklogin()){
				if(strcmp("sectionUp",$opt)===0){
							...
							if($newpos>-1){
								...
								makequery("INSERT INTO filelist(exampleno,filename,pos,appuser) VALUES ((SELECT exampleno FROM codeexample WHERE pos='$newpos' and coursename='$coursename' and sectionno='$sectid' and cversion='$vers' limit 1),'<none>',1,'$appuser');","Error Creating New Code Example");
								makequery("INSERT INTO descriptionsection(exampleno,segment,pos,appuser) VALUES ((SELECT exampleno FROM codeexample WHERE pos='$newpos' and coursename='$coursename' and sectionno='$sectid' and cversion='$vers' limit 1),'Enter description here.',1,'$appuser');","Error Creating Description Text");
