...
function maximizeBoxes(boxid) 
{
	...
	if (templateid == 9) {
		if (boxid == 1) {
            ...
            thisBox4 = document.querySelector('#box' + 4 + 'wrapper #boxtitlewrapper');
            thisBox5 = document.querySelector('#box' + 5 + 'wrapper #boxtitlewrapper');
			document.querySelector(boxValArray['box' + 2].id).style.width = '0%';
			document.querySelector(boxValArray['box' + 3].id).style.width = '0%';
			document.querySelector(boxValArray['box' + 4].id).style.width = '0%';
			document.querySelector(boxValArray['box' + 5].id).style.width = '0%';
			document.querySelector(boxValArray['box' + boxid].id).style.width = '100%';
			document.querySelector(boxValArray['box' + boxid].id).style.height = '100%';
            alignTemplate9Height3Stack(boxValArray, 2,3,4,5);
            thisBox.classList.remove('hidden');
            setTimeout(function () {
                thisBox2.classList.add('hidden');
        ...
        if (boxid == 2) {
			...
			document.querySelector(boxValArray['box' + 1].id).style.width = '0%';
			document.querySelector(boxValArray['box' + 3].id).style.width = '100%';
			document.querySelector(boxValArray['box' + 3].id).style.height = '0%';
			document.querySelector(boxValArray['box' + 4].id).style.height = '0%';
			document.querySelector(boxValArray['box' + 4].id).style.width = '100%';
			document.querySelector(boxValArray['box' + 5].id).style.height = '0%';
			document.querySelector(boxValArray['box' + 5].id).style.width = '100%';
			document.querySelector(boxValArray['box' + boxid].id).style.width = '100%';
			document.querySelector(boxValArray['box' + boxid].id).style.height = '100%';
			alignBoxesWidth(boxValArray, 1, 2);
            alignTemplate9Height3Stack(boxValArray, 2,3,4,5);
        ...
        if (boxid == 3) {
			...
			document.querySelector(boxValArray['box' + 1].id).style.width = '0%';
			document.querySelector(boxValArray['box' + 2].id).style.width = '100%';
			document.querySelector(boxValArray['box' + 2].id).style.height = '0%';
			document.querySelector(boxValArray['box' + 4].id).style.height = '0%';
			document.querySelector(boxValArray['box' + 4].id).style.width = '100%';
			document.querySelector(boxValArray['box' + 5].id).style.height = '0%';
			document.querySelector(boxValArray['box' + 5].id).style.width = '100%';
