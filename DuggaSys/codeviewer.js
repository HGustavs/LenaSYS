	...
	if ($("#" + contentid + "menu").length == 0) {
		...
		if (retData['writeaccess'] == "w") {
			if (type == "DOCUMENT") {
				...
				str += '<td id = "boxtitlewrapper" class="butto2 boxtitlewrap" title="Title"><span id="boxtitle2" class="boxtitleEditable" onblur="updateContent(\''+filename+'\','+kind+',' + boxid + ');" contenteditable>' + retData['box'][boxid - 1][4] + '</span></td>';
