	...
	for (i = 0; i < tokens.length; i++) {
		...
		if (tokens[i].kind == "rowcomment") {
			...
			if (important.indexOf(withoutQuote) != -1 ||
				...
				cont += "<span id='IW" + iwcounter + "' class='impword' onclick='popupDocumentation(\"" + tokenvalue + "\", \"php\");' onmouseover='highlightKeyword(\"" + withoutQuote + "\")' onmouseout='highlightKeyword(\"" + withoutQuote + "\")'>" + tokenvalue + "</span>";
			} else {
