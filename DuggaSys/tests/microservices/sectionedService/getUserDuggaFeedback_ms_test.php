...
$testdata = array(
    'get user dugga feedback' => array(
        'expected-output' => '{"userfeedback":[],"avgfeedbackscore":[]}', // Updating security question & answer was successful
        'query-before-test' => "INSERT INTO userduggafeedback (ufid, username, cid, lid, score, entryname) VALUES (1, 'brom', 1894, 3017, 3, NULL);",
