...
$testsData = array(  
'updateActiveCourseVersion_sectioned_ms' => array(  
        ...
        'service' => 'http://localhost/LenaSYS/DuggaSys/microservices/sectionedService/updateActiveCourseVersion_sectioned_ms.php',
