...
// TODO 'uid' should not be hard coded or manually inserted in USER table.

$testdata = [
    'update security question' => [
        'expected-output' => '{"success":true,"status":"","debug":"NONE!"}', // Updating security question & answer was successful
        'query-before-test' => "INSERT INTO user (uid, username, password, securityquestion, securityquestionanswer) VALUES (4000000, 'testuser', '$testPassword', 'What is old question', 'old');", // Insert a user with old security question
        'query-after-test' => "DELETE FROM user WHERE uid = 4000000;", // Clean up after the test
