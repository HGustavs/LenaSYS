...
$testdata = array(
    'addUser_ms' => array(  
        'expected-output' => '{"debug":"NONE!","classes":[{"class":"TESTclass1"},{"class":"DVSUG13h"},{"class":"WEBUG13h"},{"class":"WEBUG14h"}]}',
        ...
        'service-data' => serialize(
            array(
                ...
                'password' => 'password',
                'opt' => 'ADDUSR',
                'newusers' => '[["471212-1234","Fname","Lname","Addtest123@student.his.se","TESTclass1","HT-14",0]]',
                'courseid' => '1885',
                'coursevers'=> '1337'
            )),
