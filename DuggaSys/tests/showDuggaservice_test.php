...
//     ),
    'Create active users' => array(
        ...
        'query-before-test-1' => "SELECT MAX(hash) FROM groupdugga WHERE hash= 'tj7dh2nb';",
...
//             'none'
//         )),
//         'console-output' => 'echo "Hello world";'
//     ),
...
//             'none'
//         )),
//         'console-output' => 'echo "This is a message printed to the console.";'
//     ),
