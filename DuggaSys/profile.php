	...
	?>
		<div id="content">
			...
			<div style="display:inline-flex;flex-wrap:wrap;margin:0 auto 0 auto;">
				...
				<div id="changePassword" style="flex-grow: 1; border-radius: 2px; margin: 10px; box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23); padding: 20px;">
				...
				<div id="notificationsOnOff" style="flex-grow: 1; border-radius: 2px; margin: 10px; box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23); padding: 20px;">
