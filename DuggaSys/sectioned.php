					...
					<td class='hamburger hamburgerClickable'>
						...
						<div class='hamburgerMenu'>
							<ul class='hamburgerList'>
								<li class='results'>
								<a id='resultsHAM' href='' onclick='navigatePage(this.id, "resulted.php");' oncontextmenu='javascript:navigatePage(this.id, "resulted.php");'><input type='button' value='Results' class='submit-button' title='Edit student results' /></a>								</li>
								<li class='tests'>
								<a id='testsHAM' href='' onclick='navigatePage(this.id, "duggaed.php");' oncontextmenu='javascript:navigatePage(this.id, "duggaed.php");'><input type='button' value='Tests' class='submit-button' id='testbutton' title='Show tests' /></a>
								</li>
								<li class='files'>
										<a id='filesHAM' href='' onclick='navigatePage(this.id, "fileed.php");' oncontextmenu='javascript:navigatePage(this.id, "fileed.php");'><input type='button' value='Files' class='submit-button' title='Show files'/></a>
								</li>
								<li class='access'>
								<a id='accessHAM' href='' onclick='navigatePage(this.id, "accessed.php");' oncontextmenu='javascript:navigatePage(this.id, "accessed.php");'><input type='button' value='Access' class='submit-button' title='Give students access to the selected version'/></a>
								</li>
							</ul>
						</div>
					</td>
