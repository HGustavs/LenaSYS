	...
	<div id="content">
		...
		<div class='course' style='display:flex; align-items:center; justify-content:flex-end;'>
				...
				<div id='course-newitem' style='display: flex;'>
						<input id='addElement' style="display:none;" type='button' value='+' class='submit-button-newitem' onclick='createQuickItem();' title='New Item'>
				</div>
				<!-- test #1 -->
	...
	<!-- Confirm Missing Material Dialog END -->
    	...
    	<div class='loginBox' style='width:464px;'>
			...
			<div style='padding:5px;'>
				...
				<p id="dialog4" style="font-size:11px; border:0px; margin-left: 10px; display:none;">Message can only contain 50 symbols and non-nordic symbols</p>
...
<div id='editCourseVersion' onmouseover="validateVersionName('eversname', 'dialog5'); validateDate('estartdate','eenddate','dialog6');" class='loginBoxContainer' style='display:none;'>
		<div class='loginBox' style='width:464px;'>
			...
			<div style='padding:5px;'>
				...
				<p id="dialog9" style="font-size:11px; border:0px; margin-left: 10px; display:none;">Message can only contain 50 symbols and non-nordic symbols</p>
