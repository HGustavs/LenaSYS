...
<body>
	...
	<div id='editSection' class='loginBox' style='width:460px;display:none;'>
		...
		<div style='padding:5px;'>
			...
			<div id='inputwrapper-name' class='inputwrapper'><span>Comment for deadline:</span><input type='text' class='textinput' id='deadlinecomment' value='deadlinecomment' placeholder='Deadline comment' /></div>
		</div>
