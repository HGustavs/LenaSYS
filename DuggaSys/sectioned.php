	...
	<!-- Confirm Missing Material Dialog END -->
    	...
    	<div class='loginBox' style='width:464px;'>
			...
			<div style='padding:5px;'>
				...
				<p id="dialog4" style="font-size:11px; border:0px; margin-left: 10px; display:none;">Message can only contain 50 letters and may only contain letters A - Z</p>
...
<div id='editCourseVersion' onmouseover="validateVersionName('eversname', 'dialog5'); validateDate('estartdate','eenddate','dialog6');" class='loginBoxContainer' style='display:none;'>
		<div class='loginBox' style='width:464px;'>
			...
			<div style='padding:5px;'>
				...
				<p id="dialog9" style="font-size:11px; border:0px; margin-left: 10px; display:none;">Message can only contain 50 letters and may only contain letters A - Z</p>
