					...
					<td class='hamburger hamburgerClickable'>
						...
						<div class='hamburgerMenu'>
							<ul class='hamburgerList'>
								<li class='results'>
									<a class='hamburgerList' href='' onclick='navigatePage(this.id, "resulted.php");' oncontextmenu='javascript:navigatePage(this.id, "resulted.php");'><input type='button' value='Results' class='submit-button' title='Edit student results' /></a>								</li>
								<li class='tests'>
