	...
	if (data['entries'].length > 0) {
      ...
      if(courseSplitIndex>0) { // There is a space in the course name
        ...
        str += "<div class='ellipsis' style='margin-right:15px;'>";
          ...
          str += "<span style='margin-right:15px;'><a class='" + textStyle + "' href='sectioned.php?courseid=" + item['cid'] + "&coursename=" + item['coursename'] + "&coursevers=" + item['activeversion'] + "' title='\"" + item['coursename'] + "\" [" + item['activeversion'] + "] [Registred]'>" + item['coursename'] + "</a></span>";
        }else{
          str += "<span style='margin-right:15px;opacity:0.3'><a class='" + textStyle + "' href='sectioned.php?courseid=" + item['cid'] + "&coursename=" + item['coursename'] + "&coursevers=" + item['activeversion'] + "' title='\"" + item['coursename'] + "\" [" + item['activeversion'] + "] [Not registred]'>" + item['coursename'] + "</a></span>";
        }
        str += "</div>";
			}
