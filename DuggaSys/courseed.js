...
function returnedCourse(data) {
	...
	str += "<div id='lena' class='head nowrap' style='display: flex; align-items: center;justify-content: center; background-color: transparent;''><a href='https://github.com/HGustavs/LenaSYS' target='_blank'><span class='sys'><span class='lena'>LENA</span>Sys</span></a><div id='CourseOrgSys'> Course Organization System</div>"
	if (data['writeaccess']) {
