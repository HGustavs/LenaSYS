...
$(document).ready(function(){
	...
	*/
	...
	function addSubmissionRow() {
		$('#submissions').append("<div style='width:100%;display:flex;flex-wrap:wrap;flex-direction:row;'><select style='width:65px;'><option value='pdf'>PDF</option><option value='zip'>Zip</option><option value='link'>Link</option><option value='text'>Text</option></select><input type='text' name='fieldname' id='fieldname' placeholder='Submission name' style='flex:1;margin-left:5px;margin-bottom:3px;height:24.8px;' onkeydown='if (event.keyCode == 13) return false;'/><input type='text' name='instruction' id='instruction' placeholder='Upload instruction' style='flex:3;margin-left:5px;margin-bottom:3px;height:24.8px;' onkeydown='if (event.keyCode == 13) return false;'/><input type='button' class='delButton submit-button' value='-' style='width:32px;margin:0px 0px 3px 5px;'></button><br/></div>");
	}
