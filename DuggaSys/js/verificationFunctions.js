...
function validateNewSectionSubmit()
{
	...
	if( (document.newSection.type.value == 2 || document.newSection.type.value == 3) &&  document.newSection.testduggaselect.value == "-1") {
		$("select[name*='testduggaselect']").css("background-color", "#ff7c6a");
		return false;
	} else if ( document.newSection.type.value == 4 &&  document.newSection.link.value != "" ) {
		$("select[name*='testduggaselect']").css("background-color", "#89ff7b");
	}
