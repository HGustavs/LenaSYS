...
Aswell as __insertIntoTableImpwordlist__ or __deleteFromTableImpwordlist__ to add or remove a row in table __impwordlist__.
...
Uses service __deleteFromTableCodexample__ to delete a row from the table __codeexample__.
Uses service __deleteFromTableListentries__ to delete a row from the table __listentries__.
Uses service __deleteFromTableQuiz__ to delete a row from the table __quiz__.
Uses service __deleteFromTableVers__ to delete a row from the table __vers__.
Uses service __deleteFromTableCourse__ to delete a row from the table __course__.
...
### deleteDuggaVariant
Uses service __deleteFromTableUserAnswer__ to delete a row from the table __userAnswer__.
Uses service __deleteFromTableVariant__ to delete a row from the table __variant__.
...
If not in use, then service __deleteFromTableFileLink__ is used to delete a row from the table __fileLink__.
...
Retrives all removed (but not deleted from db) listentries
Uses service __selectFromTableListentries__ to _get_ information it requires from __listentries__.
