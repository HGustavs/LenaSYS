	...
	//---------------------------------------------------------------------------------------------------------------
		...
		{	
				...
				echo '<span id="hotdogdrop" class="hotdogdropStyle dropdown dropdownStyle showmobile" style="overflow:auto;">';
					...
					echo '</tr>';
echo '<tr><td class="butto " title="Show code" onclick="" colspan="4">Code<img src="new icons/hotdogTabButton2.svg" /></td></tr>';
 						echo '<tr><td class="butto " title="Show description" onclick="" colspan="4">Description<img src="new icons/hotdogTabButton2.svg" /></td></tr>';
 						echo '<tr><td class="butto " title="Show JS" onclick="" colspan="4">JS<img src="new icons/hotdogTabButton2.svg" /></td></tr>';
 						echo '<tr><td class="butto " title="Show rownumbers" onclick="" colspan="4">Show rownumbers<img src="new icons/hotdogTabButton2.svg" /></td></tr>';
