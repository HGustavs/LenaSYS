		...
		{	
			...
			echo '</span>';				
				...
				if($kind){
                    ...
                    echo '<table cellspacing="2"><tr>';
                    echo '<td class="mbutto mbuttoStyle" title="Heading" onclick="styleHeader();"><img src="new icons/hotdog_button.svg" /></td>';
                    echo '<td class="mbutto mbuttoStyle" title="Code example" onclick="styleCode();"><img src="new icons/hotdog_button.svg" /></td>';
                    echo '<td class="mbutto mbuttoStyle" title="Remove formatting" onclick="styleReset();"><img src="new icons/hotdog_button.svg" /></td>';
					echo '<td class="mbutto mbuttoStyle" title="Save" onclick="Save();"><img src="new icons/hotdog_button.svg" /></td>';
                    echo '<td class="mbutto mbuttoStyle" title="Select image" onclick="Images();"><img src="new icons/list_codefiles.svg" /></td>';
                    echo '</tr></table></div>';
