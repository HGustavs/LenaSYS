	...
	//---------------------------------------------------------------------------------------------------------------
		...
		{	
				...
				echo '<span id="hotdogdrop" class="hotdogdropStyle dropdown dropdownStyle showmobile" style="overflow:auto;">';
					...
					echo '</tr>';
						echo '<tr><td class="mbutto mbuttoStyle " title="Show code" onclick="" colspan="3">Code</td><td class="butto">IMG</td></tr>';
						echo '<tr><td class="mbutto mbuttoStyle " title="Show description" onclick="" colspan="3">Description</td><td class="butto">IMG</td></tr>';
						echo '<tr><td class="mbutto mbuttoStyle " title="Show JS" onclick="" colspan="3">JS</td><td class="butto">IMG</td></tr>';
						echo '<tr><td class="mbutto mbuttoStyle " title="Show rownumbers" onclick="" colspan="3">Show rownumbers</td><td class="butto">IMG</td></tr>';
