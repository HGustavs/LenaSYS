	...
	//---------------------------------------------------------------------------------------------------------------
		...
		{	
				...
				echo '<span id="hotdogdrop" class="dropdown showmobile" style="overflow:scroll;">';
					...
					echo '</tr>';
						echo '<tr><td class="butto " title="Show code" onclick="" colspan="3">Code</td><td class="butto"><img src="new icons/hotdogTabButton2.svg" /></td></tr>';
						echo '<tr><td class="butto " title="Show description" onclick="" colspan="3">Description</td><td class="butto"><img src="new icons/hotdogTabButton2.svg" /></td></tr>';
						echo '<tr><td class="butto " title="Show JS" onclick="" colspan="3">JS</td><td class="butto"><img src="new icons/hotdogTabButton2.svg" /></td></tr>';
						echo '<tr><td class="butto " title="Show rownumbers" onclick="" colspan="3">Show rownumbers</td><td class="butto"><img src="new icons/hotdogTabButton2.svg" /></td></tr>';
