...
Version History
 ...
 5.20	2015-05-05 -	Added feature resizable windows
						Updated design of edit windows
...
<html>
	<head>
		...
		<?php 
			...
			echo "</div>";
			if($codeviewer) echo "<div id='div2'>If this text remains this means this is an uncaught error. Please contact the admin with this message : codeviewer=true@line134-EV50.php</div>";
		?>						
		<!--- Dropdowns START --->
